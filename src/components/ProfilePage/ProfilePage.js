      ...
      <div id="container_profile3">
        ...
        <div className="game_collection_cards1">
              ...
              <div className="game_collection_into_card">
                <div className="game_collection_result1">
                  ...
                  <div className="game_collection_icons">
                    <img src="./icon-of-tinyrogues1.png" alt="icon 1" />
                    <img src="./icon-of-tinyrogues2.png" alt="icon 2" />
                    <img src="./icon-of-tinyrogues3.png" alt="icon 3" />
                  </div>
                  <div>
                    <p>Completed: 70%</p>
                    <div className="slider">
                      <div className="slider_active" style={{ width: '70%' }} />
                    </div>
                  </div>
                </div>
            ...
            <div className="game_collection_card">
              ...
              <div className="game_collection_into_card">
                <div className="game_collection_result1">
                  <h2>Hades</h2>
                  <div className="game_collection_icons">
                    <img src="./icon-of-hades1.png" alt="icon 1" />
                    <img src="./icon-of-hades2.png" alt="icon 2" />
                    <img src="./icon-of-hades3.png" alt="icon 3" />
                  </div>
                  <div>
                    <p>Completed: 20%</p>
                    <div className="slider">
                      <div className="slider_active" style={{ width: '20%' }} />
                    </div>
                  </div>
                </div>
                <div className="game_collection_result2">
          ...
          <div className="game_collection_cards2">
            <div className="game_collection_card">
              ...
              <div className="game_collection_into_card">
                <div className="game_collection_result1">
                  <h2>Mordhau</h2>
                  <div className="game_collection_icons">
                    <img src="./icon-of-mordhau1.png" alt="icon 1" />
                    <img src="./icon-of-mordhau2.png" alt="icon 2" />
                    <img src="./icon-of-mordhau3.png" alt="icon 3" />
                  </div>
                  <div>
                    <p>Completed: 45%</p>
                    <div className="slider">
                      <div className="slider_active" style={{ width: '45%' }} />
                    </div>
                  </div>
                </div>
                <div className="game_collection_result2">
            ...
            <div className="game_collection_card">
              <img src="./teamfotress2.png" alt="Team Fortress 2" />
              <div className="game_collection_into_card">
                <div className="game_collection_result1">
                  <h2>Team Fortress 2</h2>
                  <div className="game_collection_icons">
                    <img src="./icon-of-teamfotress2-1.png" alt="icon 1" />
                    <img src="./icon-of-teamfotress2-2.png" alt="icon 2" />
                    <img src="./icon-of-teamfotress2-3.png" alt="icon 3" />
                  </div>
                  <div>
                    <p>Completed: 20%</p>
                    <div className="slider">
          ...
          <div className="game_collection_cards2">
            <div className="game_collection_card">
              <img src="./tboir.png" alt="The Binding of Isaac Rebirth" />
              <div className="game_collection_into_card">
                <div className="game_collection_result1">
                  <h2>The Binding Of Isaac Rebirth</h2>
                  <div className="game_collection_icons">
                    <img src="./icon-of-tboir1.png" alt="icon 1" />
                    <img src="./icon-of-tboir2.png" alt="icon 2" />
                    <img src="./icon-of-tboir3.png" alt="icon 3" />
                  </div>
                  <div>
                    <p>Completed: 23%</p>
                    <div className="slider">
                      <div className="slider_active" style={{ width: '23%' }} />
                    </div>
                  </div>
                </div>
                <div className="game_collection_result2">
            ...
            <div className="game_collection_card">
              ...
              <div className="game_collection_into_card">
                <div className="game_collection_result1">
                  <h2>Marvel Rivals</h2>
                  <div className="game_collection_icons">
                    <img src="./icon-of-marvelrivals1.png" alt="icon 1" />
                    <img src="./icon-of-marvelrivals2.png" alt="icon 2" />
                    <img src="./icon-of-marvelrivals3.png" alt="icon 3" />
                  </div>
                  <div>
                    <p>Completed: 100%</p>
                    <div className="slider">
                      <div className="slider_active" style={{ width: '100%', borderRadius: '6.25rem', backgroundColor: '#7BC74D' }} />
                    </div>
                  </div>
                </div>
                <div className="game_collection_result2">
